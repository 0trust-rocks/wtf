...
def main():
    ...
    for file in files:
        ...
        try:
            ...
            parser = parser_class(file, output_path=args.output, source=args.source, threads=args.threads, dry_run=args.dry_run, headers=args.headers, recency_year=args.recency_year)
            parser.parse()
